#!/usr/bin/env bash
# Evaluate a model on the SNLI anti-shortcut filtered split.
#
# Usage: ./scripts/eval_snli_filtered.sh [input_view] [checkpoint] [run_dir]
#
# Examples:
#   ./scripts/eval_snli_filtered.sh pair best results/2026-01-16_233608_train_snli_bert-base-uncased
#   ./scripts/eval_snli_filtered.sh hypothesis_only best results/2026-01-25_171635_train_hypothesis_only_snli_bert-base-uncased
#
